    ...
    <body class="w3-light-grey">
        ...
        <nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
            ...
            <div class="w3-bar-block" >
                ...
                <a href="admin_overview.jsp" class="w3-bar-item w3-button w3-padding mynavitem ${param.overview}"  style="text-decoration: none" id="item"><i class="fa fa-tachometer fa-fw"></i>  Overview</a>
                <a href="admin_employee.jsp" class="w3-bar-item w3-button w3-padding mynavitem ${param.employee}"  style="text-decoration: none"><i class="fa fa-users fa-fw"></i>  Employee</a>
                <a href="admin_medical_test.jsp" class="w3-bar-item w3-button w3-padding mynavitem ${param.medicaltest}"  style="text-decoration: none" ><i class="fa fa-medkit fa-fw"></i>  Medical test</a>
                <a href="admin_useraccount.jsp" class="w3-bar-item w3-button w3-padding mynavitem ${param.useraccount}"  style="text-decoration: none" ><i class="fa fa-user-circle-o fa-fw"></i>  User account</a>
                <a href="admin_reports.jsp" class="w3-bar-item w3-button w3-padding mynavitem ${param.reports}"  style="text-decoration: none" ><i class="fa fa-bar-chart fa-fw"></i>  Reports</a>
